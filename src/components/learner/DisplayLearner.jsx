  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center">
        <div className="border-black border-2 rounded-lg px-3 flex justify-start">
          <p>{learner?.role}</p>
        </div>

        <img
          className="object-cover w-48 h-48 rounded-full pb-2 mt-5"
        ...
        <div>
          ...
          {learner.id === currentUser.id && (
            <div className="flex justify-center mt-4">
              <button
                type="button"
                className="flex items-center gap-4 text-lg font-bold text-white bg-black/80 hover:bg-gray-800/80 rounded-lg px-2 py-1"
