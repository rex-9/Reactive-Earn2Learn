    ...
    <section className="pt-24 h-full w-48 bg-white shadow-lg">
      <ul className="flex flex-col gap-4">
        ...
        <li className={handleSelected("users")}>
          ...
          >
            <img
              src={selected === "users" ? assets.usersWhite : assets.users}
              className="mr-2"
              alt="Users Dashboard"
            />
            Users
        ...
        <li className={handleSelected("studies")}>
          ...
          >
            <img
              src={
                selected === "studies" ? assets.studiesWhite : assets.studies
              }
              className="mr-2"
              alt="Studies Dashboard"
            />
            Studies
          </button>
        </li>
            ...
            <img
              src={
                selected === "certificates"
                  ? assets.certificatesWhite
                  : assets.certificates
              }
              className="mr-2"
              alt="Certificates Dashboard"
            />
            Certificates
          </button>
        </li>
        <li className={handleSelected("technologies")}>
          ...
          >
            <img
              src={
                selected === "technologies" ? assets.techsWhite : assets.techs
              }
              className="mr-2"
              alt="Technologies Dashboard"
            />
            Technologies
          </button>
        </li>
        <li className={handleSelected("invites")}>
          <button
            type="button"
            className="flex items-center"
