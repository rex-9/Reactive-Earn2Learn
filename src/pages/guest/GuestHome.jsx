  ...
  return (
    <div className=" overflow-y-auto ">
      <div className="flex flex-col font-qs items-center">
        ...
        <div className="border border-gray-300 p-6 w-[85%]  overflow-y-auto bg-white  mb-6 rounded-lg">
          {!view ? (
            <>
              {" "}
              <p className="font-bold text-lg mb-4">Recent Learners</p>
              ...
              <div className="flex justify-end mx-6 mt-4">
                <button
                  ...
                  className="bg-indigo-700 hover:bg-indigo-900 text-white font-medium py-2 px-6 rounded-lg"
                >
                  View All
                </button>
              </div>
            ...
            <>
              <p className="font-bold text-lg mb-4">All Learners</p>
              <Learners />
              <div className="flex justify-end mx-6 mt-4">
                <button
                  onClick={handleViewAll}
